...
* When setting include attribute to true and adding a file with the syntax appname.conf the recipe copies this file to a directory and include the file in the virtualhost.
